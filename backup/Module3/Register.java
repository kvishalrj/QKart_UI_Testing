...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.urlContains("https://crio-qkart-frontend-qa.vercel.app/login"), ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar"))));
        }
        catch (Exception e) {
            return false;
        }

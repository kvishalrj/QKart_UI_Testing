...
public class QKART_Tests {
    ...
    public void TestCase02() throws InterruptedException {
        ...
        // }
        assertTrue(status, "Verify user Registration Fail");
        ...
        assertFalse(status, "Verify user existing Registration Fail");
        // return !status;
    }
    ...
    public void TestCase03() throws InterruptedException {
        ...
        if (searchResults.size() == 0) {
            ...
            // return false;
            status = false;
            assertTrue(status, "Unsuccessfull");
        }
        ...
        if (searchResults.size() == 0) {
            if (homePage.isNoResultFound()) {
                ...
                assertTrue(status, "Unsuccessfull! products found message is displayed");
            }
            status = true;
            ...
            assertTrue(status, "Results were available");
            // return false;
        }
    ...
    public void TestCase05(String TC5_ProductNameToSearchFor, String TC5_ProductNameToSearchFor2, String TC5_AddressDetails) throws InterruptedException {
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            assertFalse(status, "Unsuccessfull");
